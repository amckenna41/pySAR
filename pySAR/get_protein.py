...
def fasta(fasta_path):
    ...
    -------
    :sequence : str
        parsed protein sequence in string format.
    """
...
def download_protein_from_uniprot(prot_id, save_dir="pysar_downloads"):
    """
    ...
    :save_dir : str (default="pysar_downloads")
    ...
    try:
        ...
        print('Protein {} successfully downloaded.'.format(prot_id))
    except requests.exceptions.RequestException:
        print('Error downloading protein with ID {} from the url {}.'.format(prot_id, url))

def download_protein_from_ncbi(prot_id, db="protein", email="email@example.com", save_dir="pysar_downloads"):
    """
...
def download_protein_from_pdb(pdb_id, save_dir="pysar_downloads"):
    """
